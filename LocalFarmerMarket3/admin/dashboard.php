...
// Aggregate counts and revenue for admin dashboard overview
$stats = [];
...
<div class="main-wrapper">
  ...
  <!-- UI: show alert when there are products awaiting approval -->
  ...
  <div class="grid grid-cols-4" style="margin-bottom: var(--space-3xl);">
    ...
    <div class="stat-card admin">
      ...
      <p style="margin-top: var(--space-md); font-size: var(--text-sm); opacity: 0.9;">
        <span class="material-icons">inventory_2</span> <?php echo $stats['approved_products']; ?> approved · <span class="material-icons">hourglass_top</span> <?php echo $stats['pending_products']; ?> pending
      </p>
    </div>
    ...
    <div class="stat-card secondary">
      ...
      <p style="margin-top: var(--space-md); font-size: var(--text-sm); opacity: 0.9;">
        <span class="material-icons">check_circle</span> <?php echo $stats['active_farmers']; ?> active
      </p>
    </div>
    ...
    <div class="stat-card info">
      ...
      <p style="margin-top: var(--space-md); font-size: var(--text-sm); opacity: 0.9;">
        <span class="material-icons">check_circle</span> <?php echo $stats['active_buyers']; ?> active
      </p>
    </div>
    ...
    <div class="stat-card warning">
      ...
      <p style="margin-top: var(--space-md); font-size: var(--text-sm); opacity: 0.9;">
        <span class="material-icons" aria-hidden="true">hourglass_top</span> <?php echo $stats['pending_orders']; ?> pending
      </p>
    </div>
  </div>

  <!-- Revenue card removed temporarily for demo; will be restored later -->
  ...
  <div class="grid grid-cols-2" style="margin-bottom: var(--space-3xl);">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><span class="material-icons" aria-hidden="true">hourglass_top</span> Pending Approvals</h3>
      </div>
            ...
            <div style="padding: var(--space-lg); border-bottom: 1px solid var(--gray-200); display: grid; grid-template-columns: 1fr auto; gap: var(--space-md); align-items: center;">
              <div>
                ...
                <p style="margin: 0; font-size: var(--text-sm); color: var(--gray-600);">
                  <span class="material-icons">local_farm</span> <?php echo htmlspecialchars($product['farmer_name']); ?>
                </p>
                <p style="margin: var(--space-xs) 0 0 0; font-size: var(--text-sm); color: var(--gray-600);">
                  <span class="material-icons">attach_money</span> Rs <?php echo number_format($product['price'], 2); ?>
                </p>
              </div>
      ...
      <?php else: ?>
        <div style="padding: var(--space-3xl); text-align: center;">
          <p style="margin: 0; color: var(--gray-500);"><span class="material-icons">check_circle</span> No pending approvals</p>
        </div>
      <?php endif; ?>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><span class="material-icons">inventory_2</span> Recent Orders</h3>
      </div>
          ...
          <?php foreach ($recent_orders as $order): ?>
            <div style="padding: var(--space-lg); border-bottom: 1px solid var(--gray-200); display: grid; grid-template-columns: 1fr auto; gap: var(--space-md); align-items: center;">
              <div>
                ...
                <p style="margin: 0; font-size: var(--text-sm); color: var(--gray-600);">
                  <span class="material-icons">person</span> <?php echo htmlspecialchars($order['buyer_name']); ?>
                </p>
                <p style="margin: var(--space-xs) 0 0 0; font-size: var(--text-sm); color: var(--gray-600);">
                  <span class="material-icons">event</span> <?php echo date('M j, Y', strtotime($order['order_date'])); ?>
                </p>
              </div>
