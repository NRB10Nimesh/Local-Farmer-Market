  ...
  <div style="max-width:1400px;margin:0 auto">
    ...
    <div style="display:flex;gap:16px;margin-bottom:24px;flex-wrap:nowrap;overflow-x:auto;align-items:stretch">
      <div class="card" style="background:#fef3c7;border-left:4px solid #f59e0b;min-width:200px;flex:1 0 200px">
        <div class="small-muted"><span class="material-icons" aria-hidden="true">hourglass_top</span> Pending Approval</div>
      ...
      <div class="card" style="background:#d1fae5;border-left:4px solid #16a34a;min-width:200px;flex:1 0 200px">
        <div class="small-muted"><span class="material-icons">check_circle</span> Approved</div>
      ...
      <div class="card" style="background:#fee2e2;border-left:4px solid #ef4444;min-width:200px;flex:1 0 200px">
        <div class="small-muted"><span class="material-icons">cancel</span> Rejected</div>
      ...
      <div class="card" style="background:#dbeafe;border-left:4px solid #3b82f6;min-width:200px;flex:1 0 200px">
        <div class="small-muted"><span class="material-icons">warning</span> Low Stock</div>
      ...
      <div class="card" style="background:linear-gradient(135deg, #10b981 0%, #059669 100%);color:white;min-width:220px;flex:1 0 220px">
        <div class="small" style="opacity:0.9"><span class="material-icons">attach_money</span> Potential Commission</div>
    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px">
        <h2 style="margin:0"><span class="material-icons" aria-hidden="true">inventory_2</span> Product Management</h2>
        <div style="display:flex;gap:12px">
          <a href="commission_settings.php" class="btn btn-ghost"><span class="material-icons">settings</span> Commission Settings</a>
          <a href="revenue.php" class="btn btn-primary"><span class="material-icons">attach_money</span> Revenue Report</a>
        </div>
      </div>
                ...
                <tr style="border-bottom:1px solid #e5e7eb">
                  <td style="padding:12px">
                    <div style="display:flex;gap:12px;align-items:center">
                      ...
                      <?php else: ?>
                        <div style="width:50px;height:50px;background:#f3f4f6;border-radius:6px;display:flex;align-items:center;justify-content:center"><span class="material-icons">inventory_2</span></div>
                      <?php endif; ?>
                      <div>
                  ...
                  <td style="padding:12px;text-align:center">
                    <div class="actions-cell">
                      <?php if ($product['approval_status'] === 'pending'): ?>
                        <button class="btn-icon btn-success js-approve-product" data-product='<?php echo htmlspecialchars(json_encode($product), ENT_QUOTES); ?>' title="Approve" aria-label="Approve"><span class="material-icons">check_circle</span></button>
                        <button class="btn-icon btn-danger js-reject-product" data-product-id="<?php echo $product['product_id']; ?>" title="Reject" aria-label="Reject"><span class="material-icons">cancel</span></button>
                      <?php elseif ($product['approval_status'] === 'approved'): ?>
                        <button class="btn-icon btn-ghost" onclick='updateCommission(<?php echo json_encode($product); ?>)' title="Update Commission" aria-label="Update Commission"><span class="material-icons">settings</span></button>
                        <button class="btn-icon btn-ghost" onclick='updateStock(<?php echo json_encode($product); ?>)' title="Update Stock" aria-label="Update Stock"><span class="material-icons">inventory_2</span></button>
                      <?php endif; ?>
