...
<div class="main-wrapper">
  ...
  <div style="max-width:1600px;margin:0 auto">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px">
      <h2 style="margin:0"><span class="material-icons">bar_chart</span> Commission Analytics Dashboard</h2>
      <div style="display:flex;gap:12px">
        <a href="commission_settings.php" class="btn btn-ghost"><span class="material-icons">settings</span> Settings</a>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px;margin-bottom:32px">
      <div class="card" style="background:linear-gradient(135deg, #10b981 0%, #059669 100%);color:white">
        <div class="small" style="opacity:0.9"><span class="material-icons">attach_money</span> Total Commission Earned</div>
      ...
      <div class="card" style="background:linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);color:white">
        <div class="small" style="opacity:0.9"><span class="material-icons">inventory_2</span> Total Orders</div>
        <div style="font-size:2.5rem;font-weight:700;margin:8px 0">
      ...
      <div class="card" style="background:linear-gradient(135deg, #f59e0b 0%, #d97706 100%);color:white">
        <div class="small" style="opacity:0.9"><span class="material-icons">bar_chart</span> Average Commission Rate</div>
        <div style="font-size:2.5rem;font-weight:700;margin:8px 0">
      ...
      <div class="card" style="background:linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%);color:white">
        <div class="small" style="opacity:0.9"><span class="material-icons">attach_money</span> Buyer Revenue</div>
      ...
      <div class="card" style="background:#dbeafe;border-left:4px solid #3b82f6">
        <div class="small-muted"><span class="material-icons">local_farm</span> Farmer Revenue</div>
      ...
      <div class="card" style="background:#d1fae5;border-left:4px solid #10b981">
        <div class="small-muted"><span class="material-icons">trending_up</span> Commission Margin</div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:32px">
      <!-- Commission by Category -->
      <div class="card">
        <h3 style="margin-top:0"><span class="material-icons">bar_chart</span> Commission by Category</h3>
      ...
      <!-- Commission Rate Distribution -->
      <div class="card">
        <h3 style="margin-top:0"><span class="material-icons">trending_up</span> Commission Rate Distribution</h3>
    ...
    <div class="card" style="margin-bottom:32px">
      <h3 style="margin-top:0"><span class="material-icons">emoji_events</span> Top Products by Commission Earned</h3>
    ...
    <!-- Commission by Farmer -->
    <div class="card" style="margin-bottom:32px">
      <h3 style="margin-top:0"><span class="material-icons">local_farm</span> Commission by Farmer</h3>
    ...
    <?php if (!empty($daily_trends)): ?>
      <div class="card">
        <h3 style="margin-top:0"><span class="material-icons">event</span> Daily Commission Trend (Last 30 Days)</h3>
