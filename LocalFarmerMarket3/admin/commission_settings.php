...
<div class="main-wrapper">
  ...
  <div style="max-width:1400px;margin:0 auto">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px">
      <h2 style="margin:0"><span class="material-icons">settings</span> Commission Settings</h2>
    ...
    <div class="card" style="margin-bottom:24px;background:linear-gradient(135deg, #667eea 0%, #764ba2 100%);color:white">
      <h3 style="margin-top:0"><span class="material-icons">swap_horiz</span> Bulk Commission Update</h3>
    ...
    <div class="card" style="margin-bottom:24px">
      <h3 style="margin-top:0"><span class="material-icons">bar_chart</span> Category Commission Settings</h3>
    ...
    <?php if (!empty($categories_without_settings)): ?>
      <div class="card" style="background:#fef3c7;border-left:4px solid #f59e0b">
        <h3 style="margin-top:0"><span class="material-icons">warning</span> Categories Without Settings</h3>
