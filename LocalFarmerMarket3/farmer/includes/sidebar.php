<?php
// Farmer sidebar component (navigation & quick stats)
function e($v) { 
...
<aside class="sidebar">
  ...
  <div class="card card-compact">
    ...
    <div style="padding: var(--space-md) 0; border-top: 1px solid var(--gray-200); border-bottom: 1px solid var(--gray-200); margin-bottom: var(--space-lg);">
      <p style="margin: 0 0 var(--space-xs) 0; font-size: var(--text-xs); color: var(--gray-500); text-transform: uppercase; font-weight: 600;"><span class="material-icons" aria-hidden="true">home_work</span> Farm Info</p>
  ...
  <nav style="margin-top: var(--space-2xl);">
    ...
    <a href="orders.php" class="sidebar-item <?php echo ($current_page === 'orders.php') ? 'active' : ''; ?>">
      <span class="material-icons sidebar-icon" aria-hidden="true">assignment</span>
  ...
  <div class="card card-compact" style="margin-top: var(--space-3xl);">
    <h4 style="margin: 0 0 var(--space-lg) 0;"><span class="material-icons" aria-hidden="true">bar_chart</span> Recent Orders</h4>
    <?php
    // Fetch recent orders for sidebar preview
