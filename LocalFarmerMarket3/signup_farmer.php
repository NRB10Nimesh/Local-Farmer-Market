...
// Handle farmer signup form submission and validation
...
<div class="form-container">
    ...
    <form method="POST" onsubmit="return validateSignupForm()">
        ...
        <div class="commission-section">
            <h3><span class="material-icons" aria-hidden="true">assignment</span> Commission Terms & Agreement</h3>
            ...
            <a href="commission_terms.php" target="_blank" class="terms-link">
                <span class="material-icons" aria-hidden="true">description</span> Read Full Commission Terms & Conditions →
            </a>
            ...
            <div class="radio-group">
                <label class="radio-option" onclick="selectRadio(this)">
                    ...
                    <div class="radio-label">
                        <strong><span class="material-icons" aria-hidden="true">check_circle</span> I Accept</strong>
                ...
                <label class="radio-option" onclick="selectRadio(this)">
                    ...
                    <div class="radio-label">
                        <strong><span class="material-icons" aria-hidden="true">cancel</span> I Do Not Accept</strong>
