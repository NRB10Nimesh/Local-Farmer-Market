...
// Redirect to buyer login if session is missing
...
// Load buyer profile from DB for display and sidebar data
...
// Validate date range filter (today / week / month)
...
// Build base SQL to fetch this buyer's orders
$sql = "SELECT o.*, 
...
// Append status filter to SQL when provided
...
// Append date range filter to SQL when specified
...
// Execute the prepared query and populate the orders array
$orders = [];
try {
...
// Helper: retrieve order line items for display
        ...
        <div class="content">
                            ...
                            foreach ($display_items as $item): ?>
                                <div class="order-item-row">
                                    <div class="order-item-left">
                                        ...
                                        <?php else: ?>
                                            <div class="order-item-thumb"><span class="material-icons" aria-hidden="true">inventory_2</span></div>
                                        <?php endif; ?>
            ...
            <?php else: ?>
                <div class="empty-orders">
                    <div class="empty-icon"><span class="material-icons" aria-hidden="true">inventory_2</span></div>
