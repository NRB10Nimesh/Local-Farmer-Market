...
<div class="main-wrapper">
  ...
  <div class="main-content dashboard-page">
    ...
    <a href="checkout.php" class="btn primary" style="position: relative;">
      <span class="material-icons" aria-hidden="true">shopping_cart</span> View Cart
      <?php if ($cart_count > 0): ?>
  ...
  <?php if ($message): ?>
    <div class="alert success">
      <span class="alert-icon"><span class="material-icons">check_circle</span></span>
  ...
  <?php foreach ($errors as $err): ?>
    <div class="alert error">
      <span class="alert-icon"><span class="material-icons">cancel</span></span>
      <div class="alert-content">
  ...
  <div class="grid grid-cols-3" style="margin-bottom: var(--space-3xl);">
        ...
        <div class="product-card">
          ...
          <div class="product-info">
            ...
            <p class="product-description">
              <span class="material-icons" aria-hidden="true">local_farm</span> <?php echo htmlspecialchars($p['farmer_name']); ?>
            </p>
    ...
    <?php else: ?>
      <div style="grid-column: 1 / -1; text-align: center; padding: var(--space-3xl);">
        <div style="font-size: 4rem; margin-bottom: var(--space-lg);"><span class="material-icons" style="font-size:4rem;">shopping_bag</span></div>
