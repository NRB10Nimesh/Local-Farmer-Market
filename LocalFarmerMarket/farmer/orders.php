...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_status') {
    ...
    // Updated allowed statuses to match your database enum
    $allowed_statuses = ['Pending', 'Processing', 'Completed', 'Cancelled'];
    
    if (in_array($new_status, $allowed_statuses)) {
        // Verify this order belongs to farmer's products
...
// Validate status filter - updated to match database
...
// Function to get farmer's items in an order
  ...
  <div style="max-width:1400px;margin:0 auto">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px;margin-bottom:24px">
      <div class="card" style="background:linear-gradient(135deg, #667eea 0%, #764ba2 100%);color:white">
        ...
        <div style="font-size:2.5rem;font-weight:700;margin:8px 0"><?php echo $stats['total_orders'] ?? 0; ?></div>
        <div class="small" style="opacity:0.9">All time</div>
      </div>
      
      <div class="card" style="background:linear-gradient(135deg, #f093fb 0%, #f5576c 100%);color:white">
        <div class="small" style="opacity:0.9">Pending Orders</div>
        <div style="font-size:2.5rem;font-weight:700;margin:8px 0"><?php echo $stats['pending_orders'] ?? 0; ?></div>
        <div class="small" style="opacity:0.9">Needs attention</div>
      </div>
      
      <div class="card" style="background:linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);color:white">
        <div class="small" style="opacity:0.9">Completed</div>
        <div style="font-size:2.5rem;font-weight:700;margin:8px 0"><?php echo $stats['completed_orders'] ?? 0; ?></div>
      ...
      <div class="card" style="background:linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);color:white">
        ...
        <div style="font-size:2.5rem;font-weight:700;margin:8px 0">Rs<?php echo number_format($stats['total_revenue'] ?? 0, 0); ?></div>
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:12px;margin-bottom:24px;flex-wrap:wrap">
        ...
        <?php if ($status_filter || $date_filter): ?>
          <a href="orders.php" class="btn btn-ghost">Clear Filters</a>
        <?php endif; ?>
      </div>
        ...
        <?php foreach ($orders as $order): ?>
          ...
          <div class="card" style="margin-bottom:20px;border-left:4px solid 
            ...
            <div style="display:flex;justify-content:space-between;align-items:start;margin-bottom:16px;flex-wrap:wrap;gap:12px">
              <div>
                ...
                <div class="small-muted" style="margin-top:4px">
                  ...
                  • 📞 <?php echo htmlspecialchars($order['buyer_contact']); ?>
                </div>
              </div>
              
              <div style="text-align:right">
                <span style="display:inline-block;padding:8px 16px;border-radius:12px;font-size:0.9rem;font-weight:700;
                  <?php 
                  switch($order['status']) {
                    case 'Pending': echo 'background:#fef3c7;color:#92400e;'; break;
                    case 'Processing': echo 'background:#dbeafe;color:#1e40af;'; break;
                    case 'Completed': echo 'background:#d1fae5;color:#065f46;'; break;
                    default: echo 'background:#fee2e2;color:#991b1b;';
                  }
                  ?>">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:20px">
              ...
              <div>
                <div style="font-weight:700;margin-bottom:12px;color:#374151">📦 Your Products in This Order:</div>
                <?php 
                $farmer_total = 0;
              ...
              <div>
                <div style="font-weight:700;margin-bottom:12px;color:#374151">🚚 Delivery Information:</div>
                ...
                <div style="font-weight:700;margin-bottom:12px;color:#374151">💳 Payment:</div>
