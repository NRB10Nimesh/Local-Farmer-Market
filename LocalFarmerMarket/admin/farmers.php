                ...
                <tr style="border-bottom:1px solid #e5e7eb">
                  ...
                  <td style="padding:12px;text-align:center">
                    <div style="display:flex;gap:4px;justify-content:center;flex-wrap:wrap">
                      <button class="btn btn-ghost small-btn" onclick='viewFarmer(<?php echo json_encode($farmer); ?>)'>
                        View
                      </button>
                      ...
                      <form method="POST" style="display:inline">
                        ...
                        <button class="btn btn-<?php echo $farmer['is_active'] ? 'warning' : 'success'; ?> small-btn">
                          <?php echo $farmer['is_active'] ? 'Deactivate' : 'Activate'; ?>
                        </button>
                      </form>
