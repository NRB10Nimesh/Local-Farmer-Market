...
$product_revenue_query = "SELECT 
    ...
    WHERE 1=1 $date_sql
    GROUP BY ar.product_id, ar.farmer_price, ar.admin_price
...
<div class="wrap">
  <div style="max-width:1400px;margin:0 auto">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px">
      <h2 style="margin:0">💰 Revenue & Profit Report</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px;margin-bottom:32px">
      ...
      <div class="card" style="background:linear-gradient(135deg, #f59e0b 0%, #d97706 100%);color:white">
        ...
        <div class="small" style="opacity:0.9">Total sales</div>
      </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:32px">
      <!-- Product Performance -->
      <div class="card">
        <h3 style="margin-top:0">📦 Revenue by Product</h3>
      ...
      <!-- Farmer Performance -->
      <div class="card">
        <h3 style="margin-top:0">🧑‍🌾 Revenue by Farmer</h3>
    ...
    <?php if (!empty($monthly_trends)): ?>
      <div class="card">
        <h3 style="margin-top:0">📈 Monthly Profit Trend (Last 12 Months)</h3>
