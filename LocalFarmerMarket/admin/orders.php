...
<div class="wrap">
  <div style="max-width:1400px;margin:0 auto">
    ...
    <!-- Main Content -->
    <div class="card">
      <h2 style="margin-top:0">📋 Orders Management</h2>
        ...
        <?php foreach ($orders as $order): ?>
          ...
          <div class="card" style="margin-bottom:20px;border-left:4px solid 
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:20px">
              <!-- Buyer Info -->
              <div>
                <div style="font-weight:700;margin-bottom:12px;color:#374151">👤 Buyer Information</div>
              ...
              <!-- Order Items -->
              <div>
                <div style="font-weight:700;margin-bottom:12px;color:#374151">📦 Order Items (<?php echo count($items); ?>)</div>
