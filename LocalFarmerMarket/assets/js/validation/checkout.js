...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function showPaymentInstructions(method) {
    ...
    if (method === 'esewa') {
      instructions = `
        <div class="payment-instructions-title">📱 eSewa Payment Instructions:</div>
      ...
      instructions = `
        <div class="payment-instructions-title">💰 Khalti Payment Instructions:</div>
      ...
      instructions = `
        <div class="payment-instructions-title">🏦 Bank Transfer Instructions:</div>
