...
<div class="main-wrapper profile-page">
  ...
  <main class="main-content">
    ...
    <!-- Profile Header (large card similar to Farmer profile) -->
    <div class="card profile-header" style="margin-bottom:20px">
      <div class="profile-header-inner">
        ...
        <div class="profile-meta">
          ...
          <div class="small-muted">📞 <?php echo htmlspecialchars($profile['contact']); ?></div>
          <div class="small-muted">📍 <?php echo htmlspecialchars($profile['address']); ?></div>
        </div>
