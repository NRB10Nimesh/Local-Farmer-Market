...
<div class="main-wrapper">
  ...
  <div style="max-width:1400px;margin:0 auto">
    ...
    <!-- Main Content -->
    <div class="card">
      <h2 style="margin-top:0">🧑‍🌾 Farmers Management</h2>
                ...
                <tr style="border-bottom:1px solid #e5e7eb">
                  ...
                  <td style="padding:12px;text-align:center">
                    <div class="actions-cell">
                      <button class="btn-icon btn-ghost" onclick='viewFarmer(<?php echo json_encode($farmer); ?>)' title="View" aria-label="View">👁️</button>
                      <form method="POST" style="display:inline">
                        ...
                        <button class="btn-icon <?php echo $farmer['is_active'] ? 'btn-warning' : 'btn-success'; ?>" title="<?php echo $farmer['is_active'] ? 'Deactivate' : 'Activate'; ?>" aria-label="<?php echo $farmer['is_active'] ? 'Deactivate' : 'Activate'; ?>"><?php echo $farmer['is_active'] ? '⛔' : '✅'; ?></button>
                      </form>
