  ...
  <div style="max-width:1400px;margin:0 auto">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:24px">
      <div class="card" style="background:#dbeafe;border-left:4px solid #3b82f6">
        <div class="small-muted">🛒 Total Buyers</div>
    ...
    <!-- Main Content -->
    <div class="card">
      <h2 style="margin-top:0">🛒 Buyers Management</h2>
                ...
                <tr style="border-bottom:1px solid #e5e7eb">
                  ...
                  <td style="padding:12px;text-align:center">
                    <div class="actions-cell">
                      <button class="btn-icon btn-ghost" onclick='viewBuyer(<?php echo json_encode($buyer); ?>)' title="View" aria-label="View">👁️</button>
                      <form method="POST" style="display:inline">
                        ...
                        <button class="btn-icon <?php echo $buyer['is_active'] ? 'btn-warning' : 'btn-success'; ?>" title="<?php echo $buyer['is_active'] ? 'Deactivate' : 'Activate'; ?>" aria-label="<?php echo $buyer['is_active'] ? 'Deactivate' : 'Activate'; ?>"><?php echo $buyer['is_active'] ? '⛔' : '✅'; ?></button>
                      </form>
